 ...
 */
class IdentityViewHelperTest extends \F3\Fluid\ViewHelpers\ViewHelperBaseTestcase {
	...
	public function renderGetsIdentityForObjectFromPersistenceManager() {
		...
		$viewHelper = $this->getAccessibleMock('F3\Fluid\ViewHelpers\Persistence\IdentityViewHelper', array('dummy'), array(), '', FALSE);
