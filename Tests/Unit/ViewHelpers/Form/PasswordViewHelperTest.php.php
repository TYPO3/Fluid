...
class PasswordViewHelperTest extends \F3\Fluid\ViewHelpers\ViewHelperBaseTestcase {
	...
	public function setUp() {
		parent::setUp();
		$this->viewHelper = $this->getAccessibleMock('F3\Fluid\ViewHelpers\Form\PasswordViewHelper', array('setErrorClassAttribute', 'registerFieldNameForFormTokenGeneration'));
