...
class TemplateParserPatternTest extends \F3\Testing\BaseTestCase {
	...
	public function testSPLIT_PATTERN_DYNAMICTAGS() {
		$pattern = $this->insertNamespaceIntoRegularExpression(\F3\Fluid\Core\Parser\TemplateParser::$SPLIT_PATTERN_TEMPLATE_DYNAMICTAGS, array('f3', 't3'));
	...
	public function testSCAN_PATTERN_SHORTHANDSYNTAX_VIEWHELPER() {
		$pattern = $this->insertNamespaceIntoRegularExpression(\F3\Fluid\Core\Parser\TemplateParser::$SCAN_PATTERN_SHORTHANDSYNTAX_VIEWHELPER, array('f'));
