...
class Test extends F3::Testing::BaseTestCase {
	...
	public function testSCAN_PATTERN_NAMESPACEDECLARATION() {
		$pattern = F3::Beer3::Core::TemplateParser::SCAN_PATTERN_NAMESPACEDECLARATION;
	...
	public function testSPLIT_PATTERN_DYNAMICTAGS() {
		$pattern = $this->insertNamespaceIntoRegularExpression(F3::Beer3::Core::TemplateParser::SPLIT_PATTERN_TEMPLATE_DYNAMICTAGS, array('f3', 't3'));
	...
	public function testSCAN_PATTERN_DYNAMICTAG() {
		$pattern = $this->insertNamespaceIntoRegularExpression(F3::Beer3::Core::TemplateParser::SCAN_PATTERN_TEMPLATE_VIEWHELPERTAG, array('f3'));
	...
	public function testSCAN_PATTERN_CLOSINGDYNAMICTAG() {
		$pattern = $this->insertNamespaceIntoRegularExpression(F3::Beer3::Core::TemplateParser::SCAN_PATTERN_TEMPLATE_CLOSINGVIEWHELPERTAG, array('f3'));
	...
	public function testSPLIT_PATTERN_TAGARGUMENTS() {
		$pattern = F3::Beer3::Core::TemplateParser::SPLIT_PATTERN_TAGARGUMENTS;
	...
	public function testSPLIT_PATTERN_SHORTHANDSYNTAX() {
		$pattern = F3::Beer3::Core::TemplateParser::SPLIT_PATTERN_SHORTHANDSYNTAX;
	...
	public function testSCAN_PATTERN_SHORTHANDSYNTAX_OBJECTACCESSORS() {
		$pattern = F3::Beer3::Core::TemplateParser::SCAN_PATTERN_SHORTHANDSYNTAX_OBJECTACCESSORS;
	...
	public function testSCAN_PATTERN_SHORTHANDSYNTAX_ARRAYS() {
		$pattern = F3::Beer3::Core::TemplateParser::SCAN_PATTERN_SHORTHANDSYNTAX_ARRAYS;
	...
	public function testSPLIT_PATTERN_SHORTHANDSYNTAX_ARRAY_PARTS() {
		$pattern = F3::Beer3::Core::TemplateParser::SPLIT_PATTERN_SHORTHANDSYNTAX_ARRAY_PARTS;
