...
final class ComponentRenderer implements ViewHelperInterface
{
    ...
    /**
     * Not relevant for component rendering since all arguments
     * are passed through to the component template and the ViewHelper
     * doesn't declare any own arguments.
     *
