...
final class ViewHelperNodeTest extends TestCase
{
    ...
    public function getArgumentsReturnsArgumentsSetByConstructor(): void
    {
        ...
        $subject = new ViewHelperNode($renderingContextMock, 'f', 'vh');
        $subject = $subject->withArguments($arguments);
    ...
    public function evaluateCallsViewHelperInvoker(): void
    {
        ...
        $subject = new ViewHelperNode($renderingContextMock, 'f', 'vh');
        $subject = $subject->withArguments([$this->createMock(NodeInterface::class)]);
