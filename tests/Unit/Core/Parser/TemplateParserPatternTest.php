...
class PatternsTest extends UnitTestCase
{
     ...
     * @return array
     */
    public function dataProviderSCAN_PATTERN_SHORTHANDSYNTAX_ARRAYS(): array
    {
        return [
            ['string' => '{a:b}'],
            ['string' => '{a:b, c :   d}'],
     ...
     * @return array
     */
    public function dataProviderValidArrayExpressionsBeginningAndEndingOnDigits(): array
    {
        return [
            [
     ...
     */
    protected function insertNamespaceIntoRegularExpression(string $regularExpression, array $namespace): string
    {
