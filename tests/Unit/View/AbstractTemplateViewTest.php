...
class AbstractTemplateViewTest extends UnitTestCase {
	...
	public function testBuildParserConfigurationReturnsParserConfiguration() {
		...
		$this->assertInstanceOf('NamelessCoder\Fluid\Core\Parser\Configuration', $result);
	}
	...
	public function testRenderSectionThrowsExceptionIfSectionMissingAndNotIgnoringUnknown($compiled) {
		$parsedTemplate = $this->getMockForAbstractClass(
			'NamelessCoder\\Fluid\\Core\\Compiler\\AbstractCompiledTemplate',
		...
		$view = $this->getMockForAbstractClass(
			'NamelessCoder\Fluid\View\AbstractTemplateView',
			array(), '', FALSE, FALSE, TRUE,
		...
		$this->setExpectedException('NamelessCoder\\Fluid\\View\\Exception\\InvalidSectionException');
	...
	public function testSetTemplateProcessorsDelegatesToTemplateParser() {
		$view = $this->getMockForAbstractClass('NamelessCoder\Fluid\View\AbstractTemplateView', array(), '', FALSE, FALSE, TRUE);
		$parser = $this->getMock('NamelessCoder\\Fluid\\Core\\Parser\\TemplateParser');
