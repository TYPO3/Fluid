 ...
 * This implicates that you usually have to adjust the F3::Beer3::View::TemplateView in case you implement this facet.
 * 
...
interface PostParseInterface {
	 ...
	 *
	 * @param F3::Beer3::Core::SyntaxTree::ViewHelperNode $syntaxTreeNode The current node in the syntax tree corresponding to this view helper.
