 ...
 * @scope prototype
 */
class SectionViewHelper extends F3::Beer3::Core::AbstractViewHelper implements F3::Beer3::Core::Facets::PostParseInterface {
	...
	public function postParseEvent(F3::Beer3::Core::SyntaxTree::ViewHelperNode $syntaxTreeNode, $viewHelperArguments, F3::Beer3::Core::VariableContainer $variableContainer) {
		$sectionName = $viewHelperArguments['name']->render(new F3::Beer3::Core::VariableContainer());
